...
const PricingCarDetails = () => {

    const param =useParams();
    console.log(param.idddd)
    ...
    const fetchURLdata = async()=>{
        ...
        const carResult = await axios.get(`https://gearshift-api-9isy.onrender.com/api/cars/${param.idddd}`)
  ...
  return (
    ...
    <div style={{ height: '70px' }} className='d-flex flex-column justify-content-between mt-3'>
            ...
            <div className="col-md-6 text-center">
                <h1 className='text-start ms-4 text-light display-4 fw-bold'>{carData.cName}</h1>
...
export default PricingCarDetails
