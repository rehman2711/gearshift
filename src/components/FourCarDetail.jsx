...
const FourCarDetails = () => {
    ...
    const fetchURLdata = async()=>{
        ...
        const carResult = await axios.get(`https://gearshift-api-9isy.onrender.com/api/cars/${param.iddd}`)
  ...
  return (
    ...
    <div className="container-fluid" style={{ backgroundColor: "#81b29a"}}>
    ...
    <span className='d-flex justify-content-end'><button className='btn btn-sm btn-danger fs-5 py-0 rounded-3' onClick={()=>{nav(-1)}}><i class="bi bi-backspace"></i></button></span>
            ...
            <div className="col-md-12 my-5 position-relative" style={{top:'100px', right:'10px'}}>
                <div className="card rounded-4" style={{...shadow}}>
                    ...
                    <div className="card-body">
                        ...
                        <h2>Contact Us</h2>
                        <div style={{ height: '70px' }} className='d-flex flex-column justify-content-between mt-4'>
      ...
      {/* This Container is for background only */}
